...
class MetricsTracker(object):
    ...
    def update_position(self,transactions):
        self._ledger.process_transaction(transactions)
    ...
    def manual_capital_change(self, amount):
        """change capital of ledger"""
        # self._ledger.capital_change(amount)
        raise Exception('change capital base manually not be allowed')
