...
class Term(with_metaclass(ABCMeta, object)):
    ...
    :class:`zipline.Pipeline.pipe`.

    Notes
    -----
    Most pipe API users only interact with :class:`Term` via subclasses:
    ...
    **Example:**
    ...
    def __new__(cls,
        ...
        only compute equivalent sub-expressions once when traversing a pipe
        dependency graph.
