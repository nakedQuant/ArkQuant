"""
Dependency-Graph representation of pipe API terms.
"""
import uuid
...
class TermGraph(object):
    """
    An abstract representation of pipe Term dependencies.
...
class ExecutionPlan(TermGraph):
    """
    Graph represention of pipe Term dependencies that includes metadata
...
#      when running a pipe on a given domain.
