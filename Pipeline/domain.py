"""
This module defines the interface and implementations of pipe domains.

A domain represents a set of labels for the arrays computed by a pipe.
...
class IDomain(Interface):
    ...
    def all_sessions(self):
        ...
        This determines the row labels of pipe outputs for pipelines run on
        this domain.
