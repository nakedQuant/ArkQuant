...
ASSERT_URL_MAPPING = {'equity':equity_url,'bond':bond_url,'fund':fund_url,'dual':dual_url}
...
ASSET_SUPPLEMENT_URL = {'equity_supplement':equity_supplement_url,'convertible_supplement':bond_supplement_url}
