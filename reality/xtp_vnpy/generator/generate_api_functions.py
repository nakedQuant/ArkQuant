...
if __name__ == "__main__":
    md_generator = ApiGenerator("../include/xtp_vnpy/xtp_quote_api.h", "xtp_vnpy", "md", "MdApi")
    md_generator.run()

    td_generator = ApiGenerator("../include/xtp_vnpy/xtp_trader_api.h", "xtp_vnpy", "td", "TdApi")
    td_generator.run()
