...
class ProgressModel(object):
    ...
    ----------
    nterms : int
        Number of terms in the execution trade_plan of the Pipeline being run.
    start_date : pd.Timestamp
        Start date of the range over which ``trade_plan`` will be computed.
    end_date : pd.Timestamp
        End date of the range over which ``trade_plan`` will be computed.
